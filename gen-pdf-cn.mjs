...
await page.goto('file:///Users/motive/motive-team/whistle-alibaba-bp-v10-cn.html', {
...
await page.pdf({
  path: '/Users/motive/motive-team/whistle-alibaba-bp-v10-cn.pdf',
  width: '1920px',
  height: '1080px',
...
console.log('Chinese PDF generated!');
await browser.close();
