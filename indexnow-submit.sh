...
URLS=(
  ...
  "${SITE_URL}/blog/fta-savings-calculator"
  "${SITE_URL}/blog/ai-export-analysis-guide"
  "${SITE_URL}/blog/export-voucher-agency-guide"
  "${SITE_URL}/blog/hs-code-auto-vs-manual"
  "${SITE_URL}/blog/find-hs-code-product"
  "${SITE_URL}/blog/hs-code-tariff-fta"
  "${SITE_URL}/blog/fta-tariff-checklist"
  "${SITE_URL}/blog/fta-origin-rules"
  # Blog EN
  "${SITE_URL}/blog/en/hs-code-ai-classification"
  "${SITE_URL}/blog/en/ai-export-management-tool"
  # Product pages
  "${SITE_URL}/app"
  "${SITE_URL}/app/buyer"
)
